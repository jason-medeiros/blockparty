...
// -------------------------- USER AGENT RANDOMIZATION CODE -----------------------

// Some random user agent strings (can be directily modified and added to here in the
// future by simply adding to the array.  MAKE SURE ARRAY IS NULL PTR TERMINATED.
char * browserUserAgentStrings[] = {
		"Firefox/1.0 (Windows; U; Win98; en-US; Localization; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"FireFox (X11; Linux i686; pl-PL); slackware; FireFox;"
		"Mozilla/4.0 (compatible; MSIE 7.0a1; Windows NT 5.1; SV1; .NET CLR 1.1.4322; MS IdentiServ 1.4.12)",
		"Mozilla/4.0 (compatible; MSXPLAYer2.014)",
		"Mozilla/3.0 (compatible; MuscatFerret/1.6.3; claude@euroferret.com) via proxy gateway CERN-HTTPD/3.0 libwww/2.17",
		"Mozilla/4.0 (compatible; NCSA_Mosaic; windows; SV1; .NET CLR 1.1.4322)",
		"Mozilla/3.01 (compatible; Netbox/3.5 R92.5; Linux 2.2)",
		"Mozilla/3.01 (compatible; NetBox/3.5 R92.3; Linux 2.2)",
		"Mozilla/3.01 (compatible; Netbox/3.5 R93rc3; Linux 2.2)",
		"Mozilla/3.01 (compatible; Netgem/3.6.7; netbox; Linux 2.2)",
		"Mozilla/3.0 (compatible; NetPositive/2.2.3; FreeBSD 5.2.1 i686)",
		...
		"Mozilla/4.7 [fr]C-CCK-MCD C_ASPI_1_0 (WinNT; I)",
		"Mozilla/4.73 [de] (WinNT; U)",
		"Mozilla/5.0 (X11; U; Linux i586; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.79 [en] (X11; U; SunOS 5.8 sun4m)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; PROMO)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; fr-FR; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.77 (BeOS; U; BeOS BePC; en-US)",
		"Mozilla/4.7x [en] (Win9x)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (CK-DNJ71R1)",
		"Mozilla/4.77 [en] (X11; U; SunOS 5.7 sun4u)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; fr-FR; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/4.08 [fr] (Win95; I ;Nav)",
		"Mozilla/4.7 [de] (X11; Linux)",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.18-3smp i686)",
		"Mozilla/4.5 [en] (X11; I; Alpha 06; Nav)",
		"Mozilla/4.7 [en] (X11; I; AIX 4.2)",
		"Mozilla/4.78C-br_XT_4_78 [en] (X11; U; SunOS 5.8 i86pc; Nav)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-CMIL)",
		"Mozilla/4.61 [en]C-CCK-MCD (Win95; U)",
		"Mozilla/5.0 (Windows; U; Win98; en-GB; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Netscape/7.1 (compatible; Linux; X11; de_DE; U) [Firefox 0.8]",
		"Mozilla/4.7 [en] (X11; I; Linux 2.6.4 i686)",
		"Mozilla/4.1 (BEOS; U ;Nav)",
		...
		"Mozilla/4.75 [en]C-CCK-MCD {C-UDP; VUT} (Windows NT 5.0; U)",
		"Mozilla/5.0 (X11; U; Linux i686; de-DE; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; BDP)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US) Netscape7/7.02",
		"Mozilla/4.75 [en]C-CCK-MCD {Nokia} (Windows NT 5.0; U)",
		"Mozilla/5.0 (compatible; MSIE 5.5; Windows NT 5.0) Netscape/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax) (CK-SillyDog)",
		"Mozilla/5.0 (Windows; U; Win98; fr-FR; mag0802; rv:1.0.1) Gecko/20020823 Netscape/7.0",
		"Mozilla/7.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.2) Gecko/20010726 Netscape/7.0",
		"Mozilla/4.0 Netscape 7.1",
		"Mozilla/5.0 (compatible; MSIE 5.5; Windows; NT 5.0) Netscape/7",
		"Mozilla/4.79 [en]C-CCK-MCD {UMUC/CCKUS} (Windows NT 5.0; U)",
		"Mozilla/4.0 (compatible;Netscape 7.1; Windows 98)",
		"Mozilla/4.04 [en]C-WNS2.5 (Wim95; I)",
		"Mozilla/4.71 [en]C-NECCK (Win95; I)",
		"Mozilla/4.61 [en] (X11; U; FreeBSD 4.9-RC i386)",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.5) Gecko/20031007 Netscape/7.1",
		"Mozilla/5.0 (Windows; U; WinNT4.0; fr-FR; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.77 [de] (X11; U; Linux 2.2.19-SMP i686)",
		"Mozilla/5.0Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.5) Gecko/20031007 Netscape/7.2e6/6.2",
		"Netscape/5.001 (windows; U; NT4.0; en-us) Gecko/25250101",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.4.1) Gecko/20020508 Netscape6/6.2.3 (CK-SillyDog)",
		"Mozilla/4.78C-CCK-MCD vg_472 [en] (X11; U; SunOS 5.8 sun4u)",
		"Mozilla/4.1 [ja] (X11; I; Linux 2.2.13-33cmc1 i686)",
		"Mozilla/4.8 [de] (X11; U; Linux 2.6.4-52-default i686)",
		"Mozilla/5.0 (X11; U; Linux i686; ja-JP; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.73 [en] (X11; U; Linux 2.2.19 i686)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-CA; rv:0.9.4) Gecko/20011128 Netscape 7.2",
		"Mozilla/4.5 (Windows; U; Windows NT 5.1)",
		"Mozilla/4.7 [fr] (WinNT; U)",
		"Mozilla/4.51 [en]C-CCK-MCD (WinNT; U)",
		"Mozilla/4.7 [en] (WinNT; U)",
		"Mozilla/4.7",
		"Mozilla/4.05 [en] (Win95; I)",
		"Mozilla/4.73 [en]C-SYMPA (Win95; U)",
		"Mozilla/4.76 [en] (X11; U; Linux 2.2.18 i686)",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.4) Gecko/20030603 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Win95; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.61 (Macintosh; I; PPC)",
		"Mozilla/4.8 [fr] (Windows NT 5.1; U)",
		"Mozilla/5.0 (Macintosh; U; PPC; en-US; rv:0.9.2) Gecko/20010726 Netscape6/6.1",
		"Mozilla/4.08 (Macintosh; U; PPC, Nav)",
		"Mozilla/4.8 [en] (MSIE; Windows NT 5.1; U)",
		"Mozilla/5.0 (X11; U; SunOS sun4u; ja-JP; rv:1.0.1) Gecko/20020920 Netscape/7.0",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.20-4GB i686)",
		"Mozilla/5.0 (X11; U; FreeBSD i386; en-US; rv:1.4) Gecko/20030624 Netscape/7.1",
		"Mozilla/4.79 [en] (X11; U; Linux 2.2.12 i386)",
		"Mozilla/4.7 [en] (X11; I; OSF1 V4.0 alpha)",
		"Mozilla/4.61 [en] (X11; I; Linux 2.4.25 i686)",
		"Mozilla/5.0 (Windows; U; WinNT5.1; en-US; rv:0.9.4.1) Gecko/20020508 Netscape6/6.2.3",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US; rv:1.8a2) Gecko/20040527 Netscape/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:7.01) Gecko/20010726 Netscape6/6.1",
		"Mozilla/5.0 (X11; U; HP-UX 9000/785; en-US; rv:1.6) Gecko/20020604 Netscape6/6.1",
		"Mozilla/4.77 [en]C-SYMPAL (Win95; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 StumbleUpon/1.906 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; CDonDemand-Dom)",
		"Mozilla/4.61 [en] (X11; U; ) - BrowseX (2.0.0 Windows)",
		"Mozilla/4.8C-SGI [en] (X11; U; IRIX 6.5-ALPHA-1278921420 IP32)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-10527)",
		"Mozilla/4.8 [us] (X11; U; Linux 2.4.26 i686)",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.6) Gecko/20040324 Netscape/7.1",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv 1.3) Gecko/20030313 Netscape6/6.2.3_STRS",
		"Mozilla/4.71 [en] (Windows NT 5.1; U)",
		"Mozilla/4.75 [en] (X11; U; SunOS 5.7 sun4u)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:0.9.4.1) Gecko/20020508 Netscape6/6.2.3",
		"Mozilla/4.78 [en] (X11; U; Linux 2.4.16-4GB i686)",
		"Mozilla/4.79C-CCK-MCD [en] (X11; U; SunOS 5.9 sun4u)",
		"Mozilla/4.8 [en]C-CCK-MCD (Windows NT 5.0; U)",
		"Mozilla/5.0 (X11; U; Linux i386; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		...
		"Mozilla/4.8 [en]C-CCK-MCD EBM-Compaq (Windows NT 5.0; U)",
		"Mozilla/5.25 Netscape/5.0 (X11; U; IRIX 6.3 IP32)",
		"Mozilla/5.0 (Macintosh; U; PPC Mac OS X; en-US; rv1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/5.0 (Windows; U; Win98; ja-JP; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/4.78 [en] (X11; U; Linux 2.4.9-34 i686; Nav)",
		"Mozilla/5.0 (Windows NT 5.1; rv:1.4; U) Gecko/20030624 Netscape/7.1",
		"Mozilla/4.08 (PDA; PalmOS/sony/model luke/Revision:2.0.26 (de)) NetFront/3.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; pt-BR; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.8 (AmigaOS 3.5; U)",
		"Mozilla/4.76C-SGI [en] (X11; I; IRIX 6.5 IP32)",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.4) Gecko/20020508 Netscape6/6.2.3",
		...
		"Mozilla/5.0 (X11; U; AIX 000F384A4C00; en-US; rv:1.0.1) Gecko/20030213 Netscape/7.0",
		"Mozilla/4.7 (Macintosh; ppc)",
		"Mozilla/4.79 [en] (X11; U; SunOS 5.8 sun4u; Nav)",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.4) Gecko/20011022 Netscape6/6.2",
		"Mozilla/4.73 [en] (Win98; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; rv:1.0.1) Gecko/20020823 Netscape/7.0",
		"Mozilla/4.79 [en] (Win95; U)",
		"Mozilla/4.7 [en]C-SYMPA (Win95; U)",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.2 i386; Nav)",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.2 i386)",
		"Mozilla/4.8 [en] (X11; U; Linux 2.2.16-22 i686)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; PROMO)",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7) Gecko/20040626 Netscape Navigator 4.x/4.7",
		"Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.06 (Macintosh; I; PPC, Nav)",
		"Mozilla/4.06 [en] (Direct Hit Grabber)",
		"Mozilla/4.05 [en] (WinNT; I)",
		"Mozilla/4.79 [en] (X11; U; SunOS 5.9 sun4u)",
		"Mozilla/5.0 (X11; U; SunOS sun4us; en-US; rv:1.0.1) Gecko/20020920 Netscape/7.0",
		"Netscape/7.0",
		"Mozilla/4.75 [de]C-CCK-MCD QXW0325g (Windows NT 5.0; U)",
		"Mozilla/4.76 (X11; U; Linux 2.6.3 i686)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-FRS)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040803 Netscape6/6.5",
		"Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0",
		"Mozilla/4.07C-SGI [en] (X11; I; IRIX 6.5 IP32)",
		"Mozilla/4.07 (X11; I; Nav; Linux 5.1.33 i586; )",
		"Mozilla/4.78 [uk] (WinME; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 StumbleUpon/1.995 (ax)",
		"Mozilla/4.8 [en] (Win3.11; U)",
		"Netscape 7.0",
		"Netscape 7.02",
		"Mozilla/5.0 (X11; U; Linux 2.4.2-2 i586; en-US; m18) Gecko/20010131 Netscape6/6.01",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.26 i686)",
		...
		"Mozilla/5.0 (Windows; U; Win 9x 4.90; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; CDonDemand-Dom)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02 (ax)",
		"Netscape/7.1 [de] (Windows NT 5.1; U)",
		"Mozilla/5.0 (X11; U; Linux i686; fr-FR; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.2 i686)",
		"Mozilla/4.71 [en] (Win98; I)",
		"Mozilla/4.6 [de] (Win98; I)",
		"Mozilla/4.08 (PDA; PalmOS/sony/model prmr/Revision:2.0.22 (en)) NetFront/3.1",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Netscape Gecko/20040803",
		"Mozilla/5.5 (Windows; U; Windows NT 5.1; en-US; rv:0.9.2) Gecko/20010726 Netscape6/6.1",
		...
		"Mozilla/4.79C-SGI [en] (X11; I; IRIX 6.5 IP32)",
		"Mozilla/4.7 (Macintosh; I; PPC)",
		"Mozilla/4.06 [en] (WinNT; I)",
		"Mozilla/4.78 [en] (Win95; U)",
		...
		"Mozilla/4.72 [en] (Win95; I) WebWasher 3.3",
		"Mozilla/4.76 [en]C-CCK-MCD (Win98; U)",
		"Mozilla/4.04 [en] (X11; I; HP-UX B.10.20 9000/712)",
		"Mozilla/4.79C-SGI [en] (X11; I; IRIX64 6.5 IP35)",
		"Netscape 6.1 (X11; I; Linux 2.4.18 i686)",
		"Mozilla/4.08 (PDA; PalmOS/sony/model luke/Revision:2.0.22 (en)) NetFront/3.1",
		"Mozilla/4.76",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; rv:1.7.3) Gecko/20040913 Mozilla/5.0 (Windows; U; Win98; en-US; Localization; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)/0.10 (ax)",
		"Mozilla/5.0 (X11; U; FreeBSD i386; en-US; rv:1.6) Gecko/20040418 Netscape/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-Friars!)",
		"Mozilla/4.74 [en] (WinNT; U)",
		"Mozilla/4.08 [en] (Win98; U ;Nav)",
		"Mozilla/4.51C-ASML_1N06S [en] (X11; I; SunOS 5.8 sun4u)",
		"Mozilla/4.75 [en] (X11; U; Linux 2.2.16-22 i686)",
		"Mozilla/4.76 [en] (X11; U; OSF1 V5.1 alpha)",
		"Mozilla/4.08 [en] (X11; U; Linux 2.4.9-34 i686)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; de-DE; rv:1.0.2) Gecko/20021120 Netscape/7.01",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		...
		"Mozilla/4.78C-CCK-MCD [en] (X11; U; HP-UX B.10.26 9000/785)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.01 (CK-FEL-IcD)",
		"Mozilla/4.7 [en] (Windows NT 5.0; U)",
		"Netscape/7.0 (BeOS 5; x86; NetServer; en-US) Gecko/20040604",
		"Mozilla/5.0 (X11; U; Linux i686; rv:1.7.3) Gecko/20040913 Netscape/7.1",
		"Mozilla/5.0 (Macintosh; U; PPC; de-DE; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/4.77 [en] (X11; U; Linux 2.4.24 i686)",
		...
		"Mozilla/4.78 [en] (X11; U; Linux 2.4.8-26mdk i686)",
		...
		"Mozilla/4.8 [en] (Win95; U)",
		"Mozilla/4.79 [en] (X11; U; HP-UX B.11.00 9000/785)",
		...
		"Mozilla/4.76 [en]C-CCK-MCD cf476 (Windows NT 5.0; U)",
		"Mozilla/5.0 (Windows; U; Win95; en-US; rv:1.0.2) Gecko/20021120 Netscape/7.01",
		"Mozilla/4.74 [en]C-DIAL (Win98; U)",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.2) Gecko/20010726 Netscape/7.1",
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02 (CK-SillyDog)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7) Gecko/20040625 Netscape/7.2 (ax)",
		"Mozilla/5.0 (Windows; U; Win 9x 4.90; en-US; rv:1.0.1) Gecko/20040823 Netscape/7.0",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-4arcade)",
		"Mozilla/4.76 (Macintosh; I; PPC; Incompatible my ass! What if I don't want your jerky, elitist, ugly-assed css crap? Screw you!)",
		"Mozilla/4.04 [en] (WinNT; I)",
		"Mozilla/4.7 [en] (X11; I; HP-UX B.10.20 9000/782)",
		"Mozilla/5.0 (Windows NT 5.1; U; de-DE; rv:1.4) Gecko/20030619 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.5) Gecko/20041204 Netscape/7.1 (ax)",
		"Mozilla/4.8 [en] (Windows NT 5.1; U) (via translate.google.com)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:0.9.4.1) Gecko/20020508 Netscape6/6.2.3 (ax)",
		...
		"Mozilla/4.76 [en]C-bls40 (Win98; U)",
		"Mozilla/4.76 [en] (X11; U; HP-UX B.11.00 9000/785)",
		"Mozilla/4.7 [en, US, en_US] (Win95; U)",
		"Mozilla/4.5 [en]C-CCK-MCD snapN45b1 (Win98; I)",
		"Mozilla/5.0 (Windows; U; Win98; nl-NL; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",
		"Mozilla/4.7 [de]C-SYMPA (Win95; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-LucentTPES)",
		"Mozilla/5.0 (X11; U; Linux-2.6.4-4GB i686; en-US; m18;) Gecko/20030624 Netscape/7.1",
		"Mozilla/4.78C-ja [ja/Vine] (X11; U; Linux 2.4.22-0vl2.11 i686)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02 (CK-DNJ702R1)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7) Gecko/20040625 Netscape/7.2 (as)",
		"Mozilla/4.75 compatible - Mozilla/5.0",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax) Mnenhy/0.6.0.104",
		...
		"Mozilla/5.0 (X11; U; SunOS sun4m; en-US; rv:1.0.1) Gecko/20020920 Netscape/7.0",
		"Mozilla/4.04 [en] (X11; I; SunOS 5.5.1 sun4m)",
		"Mozilla/4.78 [en] (Win98; I) IBrowse/2.3 (MorphOS 1.4)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; de-DE; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (Donzilla/0.2)",
		"Mozilla/4.08 [en] (Win16; U ;Nav)",
		"Mozilla/4.0 (compatible; Netscape 7.0; Windows 98)",
		"Mozilla/5.0 (compatible; Netscape 7.0; Windows 98)",
		"Mozilla/4.0 (compatible; Netscape 7.0; Windows NT 4.0)",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.6) Gecko/20040113 Netscape 7.1",
		"Mozilla/4.08 [en] (WinNT; I)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; sk-SK; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",
		"Mozilla/4.7 [de]C-CCK-MCD QXW0322a (WinNT; I)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.2) Gecko/20010726 Netscape7/7.2",
		"Mozilla/5.0 (compatible;Netscape 4.76 Mozilla 1.4;Linux 2.6.7)",
		"Mozilla/5.0 (compatible; X11; U; SunOS 5.8 sun4u) Netscape7/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.7.1) Gecko/20040707 Netscape7/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; fr; rv:1.7) Netscape7/7.1",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US) Netscape7/7.1",
		"Mozilla/5.0 (X11; U; Linux 2.4.2-2 i586; en-US; m18) Gecko/20010131 Netscape7/7.0",
		"Mozilla/5.0 (X11; Linux i686) Netscape7/7.1",
		"Netscape7",
		"Netscape Navigator 4.5 (Windows; U; Windows NT 5.1; sl-SI; rv:1.4) Netscape/4.5",
		"Mozilla/5.0 (X11; U; SunOS sun4u; en-US; rv:1.0.1) Gecko/20020921 BigBrother/Netscape6",
		"Netscape 2.1 (compatible; MSIE 2.0B1; Windows for Workgroup 3.11; i386; en-US)",
		"Mozilla/5.0 (Windows; U; Windows NT 7.0; en-US; rv:1.7.3) Gecko/20040910 Netscape/7.1 (ax)",
		...
		"Mozilla/4.61 [en]C-CCK-MCD (WinNT; U)",
		"Mozilla/5.0 (Windows; U; Win98; en-GB; rv:0.9.4) Gecko/20011019 Netscape6/6.2",
		...
		"Mozilla/5.0 (Windows; U; Win98; en-GB; rv:0.9.4.1) Gecko/20020508 Netscape6/6.2.3",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; pt-BR; rv:1.0.1) Gecko/20020823 Netscape/7.0",
		...
		"Mozilla/5.0 (Windows; U; Win98; en-CA; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Netscape",
		"Mozilla/4.61 [en] (Win98; U)",
		"Mozilla/5.0 (Windows; U; Win98; fr-FR; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (BDP)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; de-DE; rv:1.4) Gecko/20030619 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; ja-JP; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; PROMO)",
		"Mozilla/4.8C-SGI [en] (X11; U; IRIX 6.5 IP32)",
		"Mozilla/5.0 (Macintosh; U; PPC; en-US; rv:0.9.4) Gecko/20011130 Netscape6/6.2.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax) (CK-SillyDog)",
		"Mozilla/5.0 (Windows; U; Win95; ja-JP; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.5) Gecko/20031007 Netscape/7.2",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.6) Gecko/20040210 Netscape/7.1",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US) Netscape6/6.1",
		"Mozilla/4.79 [en] (Windows NT 5.1; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02 (ax)",
		"Mozilla/5.0 (Netscape7.1; Windows NT 5.1)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.2) Gecko/20021120 Netscape/7.01 (CK-N_O_K_I_A)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax) WebWasher 3.3",
		"Mozilla/4.78 [en] (X11; U; AIX 4.3)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax [RLP])",
		"Mozilla/4.79 [en] (Netscape 4.79; Windows NT 5.1; U)",
		"Mozilla/5.0 (compatible; Netscape 4.08; Windows 98; DigExt)",
		"Mozilla/5.0 (Windows NT 5.1; en-GB; rv:1.7.2) Gecko/20040804 Netscape/7.2",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; de-DE; rv:1.4) Gecko/20030619 Netscape/7.1 (CK-UKL)",
		"Mozilla/4.08",
		"Netscape/7.2",
		"Mozilla/5.0 (X11; U; Linux-2.6.4-4GB i686; en-US; m18;) Gecko/20030624 Netscape/7.0",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.7) Gecko/20040617 Netscape/7.02",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7.5) Gecko/20041107 Netscape/7.2",
		"Mozilla/4.76 [en] (X11; U; SunOS 5.8 sun4m)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.0",
		"Mozilla/5.0 (X11; U; Linux; en-US; rv:1.0.1) Netscape/7.0",
		"Mozilla/5.0 (Macintosh; U; PPC; fr-FR; rv:0.9.4) Gecko/20011130 Netscape6/6.2.1",
		"Netscape 7",
		"Netscape 7.2",
		"Mozilla/7.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.2) Gecko/20010726 Netscape7/7.1",
		"Mozilla/4.5 [en] (X11; I; IRIX64 6.5 IP30) Mozilla/4.08 [en] (Win95; I ;Nav)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.4) Gecko/20030624 Netscape/7.01 (ax) (CK-SillyDog)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (Donzilla/0.6a)",
		"Mozilla/5.0 (compatible; MSIE 6.0; Netscape/7.0;)",
		"Mozilla/4.79 [de] (X11; U; Linux 2.2.20 i686)",
		...
		"Mozilla/4.76 (000000000; 0; 000)",
		"Mozilla/5.0 (Windows; U; Win98; en-CA; rv:0.9.4.1) Gecko/20020508 Netscape6/6.2.3",
		"Netscape/7.0 [en] (Windows NT 5.1; U)",
		"Mozilla/4.0 (compatible; Netscape 7.3R; Windows 92)",
		"Mozilla/4.7 [en] (Macintosh; I; PPC)",
		"Mozilla/4.7 [ja] (Macintosh; I; PPC)",
		"Mozilla/4.61 (X11; )",
		"Mozilla/4.7 [ja] (Win98; I)",
		"Mozilla/4.77 [en] (X11; U; Linux 2.4.9-34 i686)",
		"Netscape 4.79",
		"Mozilla/4.7x [en] (Win95; U)",
		"Mozilla/4.7 [en]C-CCK-MCD EBM-Compaq1 (Win95; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax",
		"Mozilla/4.76 [en] (X11; U; Linux 2.4.16 i686)",
		"Mozilla/4.04 (Linux i686; 1.7.3; Linux i686)",
		"Mozilla/5.0 (Windows; U; WinNT; en-US; Localization; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/4.79C-CCK-MCD [en] (X11; U; Linux 2.4.28-1-p4smp i686)",
		"Mozilla/4.61 [en] (X11; I; Linux 2.2.13-33cmc1 i686)",
		"Mozilla/5.0 (Windows; Windows NT 5.1; .NET CLR) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/4.79C-Boeing UNIX Kit [en] (X11; U; SunOS 5.8 sun4u)",
		"Mozilla/5.0 (Macintosh; U; PPC; ja-JP; rv:1.0.2) Gecko/20021120 Netscape/7.01",
		"Mozilla/4.5 [en]C-CCK-MCD (Win98; I)",
		"Mozilla/4.8 [en] (Solaris)",
		"Mozilla/4.8 [en] (X11; U; Linux 2.4.27-ow1 i686)",
		"Mozilla/5.0 (Windows NT 5.1; U) Netscape/7.0",
		...
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (nscd2)",
		"Mozilla/4.08 [en] (Win98; I ;Nav)",
		"Mozilla/4.7 [en]C-CCK-MCD NSCPCD47 (Win95; I)",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.6) Gecko/20040206 Netscape/7.3 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:0.9.2) Gecko/20010726 Netscape7/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; rv:1.6) Gecko/20040206 Netscape6/6.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; de-DE; rv:1.4) Gecko/20030619 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en; rv:1.0) Netscape/6.0",
		"Mozilla/4.8C-SGI [en] (X11; U; IRIX64 6.5 IP30)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; Localization; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows XP; en-US; rv:1.7.5) Netscape 7.4",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.5) Gecko/20041107 Mozilla; Netscape/7.1",
		"Mozilla/4.08 (PPC; Windows CE/1.0.0) NetFront/3.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US; rv:1.4) Gecko/20030624 Netscape/7.1",
		"Mozilla/4.75C-CERN UNIX pcjinr02 45 [en] (X11; U; Linux 2.2.19-6.2.1.1 i686)",
		"Mozilla/5.0 Galeon/1.3.17 (X11; Linux i686; U;) Gecko/0-pie Netscape6/6.2.3",
		"Mozilla/4.77 [en] (X11; U; AIX 4.3)",
		"Mozilla/4.77 [en] (X11; U; Linux 2.4.27-c800-1 i686)",
		"Mozilla/5.0 (Macintosh; U; PPC Mac OS X Mach-O; en-US; rv:1.8b) Gecko/20050204 Netscape/7.2 (PowerBook)",
		"Netscape 6.2 (Macintosh; N; PPC; ja)",
		"Mozilla/5.0 (Macintosh; U; PPC Mac OS X Mach-O; en-US; rv:1.8b) Gecko/20050208 Netscape/7.2 (PowerBook)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.1 (ax)",
		"Mozilla/5.0 (X11; U; SunOS sun4u; en-US; rv:1.4a) Gecko/20020920 Netscape/7.0",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.6 (Compatible with Netscape/7.2)) Gecko/20041027 Debian/1.6-5.1.0.45.lindows0.69",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7.5) Gecko/20011022 Netscape6/6.2",
		"Mozilla/5.0 (compatible; Netscape6/6.2.1; Macintosh; en-US)",
		"Mozilla/5.0 (Macintosh; U; PPC Mac OS X Mach-O; ja-JP; rv:1.4) Gecko/20030624 Netscape/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (Donzilla/0.6a2)",
		"Mozilla/4.08 [en] (Windows 3.11; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-AAPT)",
		"Mozilla/4.77 [en]C-SYMPAL (Win95; U)",
		"Mozilla/4.04 [en] (Win2000; I)",
		"Mozilla/5.0 (Windows; U; Win98; en-US; Localization; rv:1.4) Gecko/20030624 Netscape/7.2 (ax)",
		"Mozilla/4.08 (PDA; PalmOS/sony/model atom/Revision:2.0.26 (de)) NetFront/3.1",
		"Mozilla/4.7C-CCK-MCD [en] (X11; I; SunOS 5.6 sun4u)",
		"Mozilla/4.77 [en] (X11; U; Linux 2.2.19-6.2.1 i586)",
		"Mozilla/7.1 [en] (Windows NT 5.1; U)Netscape",
		"Mozilla/5.0 (Windows; U; Win98) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/4.8 [en] (wouw)",
		"Mozilla/4.5 [en] (Windows NT 5.1; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-GB; mag1001; rv:0.9.4) Gecko/20011019 Netscape6/6.2",
		...
		"Mozilla/4.78 [en] (X11; U; SunOS 5.9 i86pc)",
		...
		"Mozilla/4.73C-CCK-MCD VerizonDSL (Macintosh; U; PPC)",
		...
		"Mozilla/4.5 [en]C-AtHome0405 (WinNT; U)",
		...
		"Mozilla/5.0 (Windows; U; Win98; en-US; rv:1.4) Gecko/20030624 Netscape/7.1 (ax; CDonDemand-Dom)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.0 (NSEUPD V44 14.11.2003)",
		"Mozilla/4.5",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US; rv:1.5) Gecko/20031007 Netscape/7.2",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.2) Gecko/20021120 Netscape/7.01 (CK-Disanet)",
		"Mozilla/5.0 (Macintosh; U; PPC; fr-FR; rv:1.0.2) Gecko/20030208 Netscape/7.02",
		"Mozilla/5.0 (compatible; MSIE 5.5; Windows NT 5.0) Netscape 7.1",
		"Mozilla/4.04 [en] (Win95; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-WICGR/MIT)",
		"Mozilla/4.08 (PDA; PalmOS/sony/model atom/Revision:2.0.22 (en)) NetFront/3.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-NGA)",
		"Mozilla/5.0 (Windows; U; Win95; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; fr-FR; rv:1.0.2) Gecko/20030208 Netscape/7.02 (CK-Ifremer)",
		"Mozilla/5.0 (Windows; U; WinNT4.0; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (CK-N_O_K_I_A)",
		"Mozilla/5.0 (Windows; U; Win98; fr-FR; rv:1.4) Gecko/20030624 Netscape/7.1 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.5) Gecko/20041107 Netscape/7.2",
		"Mozilla/5.0 (compatible; MSIE 5.5; Windows NT 5.0; PPC Mac OS X; en-us) Netscape/7.2",
		"Mozilla/4.08 (SmartPhone; Symbian OS-Series60/1.03) NetFront/3.2",
		"Mozilla/4.7 [en] (Windows NT 5.1; U)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:0.9.2) Gecko/20010726 Netscape7/7.1",
		"Netscape (Windows; U; Windows NT 5.0; en-US; rv:1.7.5) Navigator/6.2",
		"Mozilla/5.0 (Linux 2.6.5) Gecko/20010726 Netscape6/6.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.7.6) Gecko/20050225 Netscape/8.0",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; de-DE; rv:1.0.1) Gecko/20020823 Netscape/7.0 (BDP),gzip(gfe) (via translate.google.com)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; de-DE; rv:1.0.1) Gecko/20020823 Netscape/7.0 (BDP)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.1) Gecko/20020823 Netscape/7.0 (OEM-HPQ-PRS1C03)",
		"Netscape 1.22 (Win16; I)",
		"Mozilla/4.76 [en] (PalmOS; U; WebPro/3.0; Palm-Arzl)",
		"Mozilla/5.0 (Windows; U; Win98; de-DE; rv:0.9.2) Gecko/20010726 Netscape7/7.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; de-DE; rv:0.9.2) Gecko/20010726 Netscape6/6.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-CA; rv:0.9.4) Gecko/20011128 Netscape6/6.2.1",
		"Mozilla/5.0 (OpenBSD; en-US) Gecko/20030624 Netscape/7.2",
		"Mozilla/5.0 (Macintosh; U; PPC; en-US; rv:0.9.4) Gecko/20011022 Netscape6/6.2",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.0.2) Gecko/20030208 Netscape/7.02 (CK-MIT)",
		...
		"Netscape 7.2 (X11; I; Linux 2.4.18 i686)",
		"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.7.6) Gecko/20050306 Netscape/7.2",
		"Netscape 4.0",
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape6/6.1",
		"Mozilla/5.0 (Windows; U; Windows NT 5.0; en-US; rv:1.7.2) Gecko/20050208 Netscape/7.20",
		"Mozilla/4.8 [en] (Linux; U)",
		"netscape (compatible; netscape; linux; SV1; .NET CLR 1.1.4322)",
		"Mozilla/4.5 (Macintosh; U; PPC)",
		"Mozilla/5.0 (Windows; U; Windows NT 5.2; pl-PL; rv:1.7.6) Gecko/20050309 Netscape/6.2",
		...
		"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2",
		"Mozilla/4.76 [en] (X11; U; FreeBSD 5.2-RC i386)",
		"Mozilla/5.0 [en] (Windows; U; Windows NT 5.1; en-US; rv:1.7.2) Gecko/20040804 Netscape/7.2 (ax)",

		NULL // terminator
};


// Returns a newly allocated user agent array (same as above)
char ** BP_GenerateBrowserAgentOnlyArray()
{

	char **retTable = (char **) bpcalloc(sizeof(browserUserAgentStrings), 1);
	if(!retTable)
		return NULL;

	size_t x = 0;
	size_t count = BP_HTTPUserAgentCount(browserUserAgentStrings);
	for(x = 0; x < count; x++){
		retTable[x] = bpstrdup(browserUserAgentStrings[x]);
	}
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// %%%%%%%%%%%%% HUGE LIST OF BROWSER STRINGS, CONTAINS ODDBALLS %%%%%%%%%%%%
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

char *allUserAgentStrings_ODD[] = {
		"( Robots.txt Validator http://www.searchengineworld.com/cgi-bin/robotcheck.cgi )",
			...
			"WebSearchBench WebCrawler V1.0 (Beta)- Prof. Dr.-Ing. Christoph Lindemann- UniversitÃ¤t Dortmund- cl@cs.uni-dortmund.de- http://websearchbench.cs.uni-dortmund.de/",
...
char ** BP_GenerateAllAgentsArray()
{
	...
	// create a table
	char **retTable = (char **) bpcalloc((sizeof(allUserAgentStrings_ODD)+sizeof(browserUserAgentStrings)), 1);
	if(!retTable)
		return NULL;

	// add oddball strings
	size_t x = 0;
	size_t count = BP_HTTPUserAgentCount(allUserAgentStrings_ODD);
	for(x = 0; x < count; x++)
	{
		retTable[x] = bpstrdup(allUserAgentStrings_ODD[x]);
	}

	// add standard browser strings
	count = BP_HTTPUserAgentCount(browserUserAgentStrings);
	size_t n = 0;
	for(; x < count; x++)
	{
		retTable[x] = bpstrdup(allUserAgentStrings_ODD[n]);
		n++;
	}

	// return the table (already null ptr terminated by calloc call)
	return retTable;
...
size_t BP_HTTPUserAgentCount(char **userAgents)
{
	...
	// ensure we have user agents
	if(!userAgents)
		return 0;

	// ensure we have a first entry
	if(!*userAgents)
		return 0;

	// count elements
	size_t x= 0;
	for(x = 0; userAgents[x]; x++){}
...
// Returns a pseudorandom result from the agents array
char * BP_HTTPGetRandomUserAgentString(char **agents, size_t totalElements)
{
	...
	// ensure we have a element count
	if(!totalElements)
		return NULL;

	// create a random selector
	size_t random_selector = BP_GenRandomUnsignedLong(0, totalElements-1);

	// duplicate random uer string and return
	char *retStr = bpstrdup(agents[random_selector]);

	// return the duplicated user agent string
	return retStr;
